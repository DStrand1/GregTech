    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            builder.aisle("CIC", "RTR", "GSG", "#Y#")
                    ...
                    .where('R', MetaBlocks.TRANSPARENT_CASING.getState(TransparentCasing.CasingType.REINFORCED_GLASS))
                    .where('T', MetaBlocks.MUTLIBLOCK_CASING.getState(MultiblockCasing.CasingType.TUNGSTENSTEEL_GEARBOX_CASING))
