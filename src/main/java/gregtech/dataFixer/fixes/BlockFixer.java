...
public class BlockFixer implements IFixableData {
    ...
    public NBTTagCompound fixTagCompound(final NBTTagCompound compound) {
        ...
        if (!GregtechDataFixers.worldSavedData.dataFixes) return compound;
        ...
        GregtechDataFixers.blockFixDefinitions.stream()
            .map(fixDef -> {
        ...
        try {
            ...
            GTLog.logger.error("Failed converting blocks:");
            e.printStackTrace();
        }
